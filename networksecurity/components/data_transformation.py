...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        '''
        It initializes a KNNImputer object with the parameteres specified in the training pipeline.py file
        and it returns a Pipeline object with the KNNimputer object as the first step.
        ...
        Returns:
            A Pipeline Project
        '''
        logging.info("Entered get_data_transformer object method of Datatransformation classs")
        try:
