...
class DataValidation:
    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        try:
            ...
            ## read the data from test and train file path
            ...
            if len(numeric_cols) <=0:
                error_message = f"train dataframe does not contain numeric columns \n"
            numeric_cols = test_dataframe.select_dtypes(include='number').columns
            if len(numeric_cols) <=0:
                error_message = f"test dataframe does not contain numeric columns \n"
